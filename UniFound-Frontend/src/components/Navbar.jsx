...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50">
      ...
      <div className="absolute top-0 left-0 w-full h-24 bg-white/30 backdrop-blur-md pointer-events-none [mask-image:linear-gradient(to_bottom,white_60%,transparent)]"></div>
          ...
          <div className="flex items-center gap-3 relative">
            {!user ? (
              ...
              <>
                ...
                <button
                  className={`p-2 rounded-full transition relative ${location.pathname === "/favourites" ? "bg-red-50 text-red-500" : "hover:bg-gray-100 text-gray-600"}`}
